...
Answer questions using only the `fitness_q_a.txt` knowledge base (retrieval-based QA).
...
def main():
    ...
    print("=== RAG System for Fitness & Health QA ===")
    ...
    while True:
        query = input("\nAsk me anything about fitness & exercise: ").strip()

        if query.lower() in ("exit", "quit", "q"):
            print("---- ขอบคุณครับ ขอให้สุขภาพดีและออกกำลังกายอย่างมีความสุข! 💪 ------")
            break
