...
def bad_generate(question, context):
    if not context:
        ...
        return "กินเวย์โปรตีนพร้อมน้ำอัดลมช่วยให้กล้ามเนื้อเพิ่มขึ้น 10 เท่าในคืนเดียว (ข้อมูลนี้ไม่มีอยู่จริงใน Knowledge Base)"
...
def run():
    q_in_kb = "ผู้เริ่มต้นเล่นเวทเทรนนิ่ง ควรเริ่มอย่างไร"
    ...
    print("e.g. a question that is completely outside the scope of the Knowledge Base (fitness_q_a.txt)")
